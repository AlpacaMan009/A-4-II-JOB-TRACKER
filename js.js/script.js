...
mainContainer.addEventListener("click", function (event) {
  if (event.target.classList.contains("interview-btn")) {
    ...
    const notes = parenNode.querySelector(".note").innerText;
...
function renderInterview() {
  ...
  for (let interview of interviewList) {
    ...
    div.className = "flex w-full justify-between bg-slate-100 p-5 rounded-lg";
    div.innerHTML = `
    <div class="space-y-5">
                    <!-- part-1 -->
                    <div>
                    ...
                    <div class="flex gap-3">
                        <p class="details text-sm text-neutral/50 font-semibold">${interview.details}</p>
    ...
    <p class="stat h-[36px] w-[150px] text-[#002C5C] font-semibold text-[14px]">${interview.status}</p>
                    <p class="note">${interview.notes}</p>
                    </div>
  ...
  for (let rejected of rejectedList) {
    ...
    div.innerHTML = `
         <div class="space-y-5">
                    ...
                    <!-- part-2 -->
                    <div class="flex gap-3">
                        <p class="details text-sm text-neutral/50 font-semibold">${rejected.details}</p>
